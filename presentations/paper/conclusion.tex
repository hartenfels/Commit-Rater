...
Both research questions were successfully answered: commits were recognized by the aformentioned criteria and by using machine learning, we successfully validated our personal criteria by correlating it with the criteria from reputable sources\TODO{maybe fix when it's done}.
