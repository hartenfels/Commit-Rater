...
Only one of our research question has been answered positively: ``good'' commits were recognized by the aformentioned criteria. However, not all of our criteria could be validated by using machine learning attribution, some simply due to the criteria itself not being good, some due to the approach of machine learning not being applicable to the data set.
