...
% TODO: Describe general synthesis process, focusing on input and output
% TODO: List all criteria with details
% TODO: Try to express criteria as metrics. I guess we count how many of an author's commits meet each criterion, and that count is our metric.
